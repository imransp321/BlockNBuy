...
namespace WebApplication
{
    public class BundleConfig
    {
        ...
        private static void RegisterExamples(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Examples/qrcode").Include(
               "~/Scripts/Examples/jquery.qrcode.min.js.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Examples/Register/qrcode/min").Include(
                "~/Scripts/Examples/jquery.qrcode.js.js"));
        }
